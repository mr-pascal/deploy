...
def public_pages():
    return [
        ...
        Page("frontend/pages/config/pz_mm/app.py", "PZ MM", "👨‍🏫"),
        Page("frontend/pages/config/pmm_dynamic/app.py", "PMM Dynamic", "👩‍🏫"),
        Page(
            "frontend/pages/config/dman_maker_v2/app.py", "D-Man Maker V2", "🤖"
        ),
        ...
        Page(
            "frontend/pages/data/tvl_vs_mcap/app.py", "TVL vs Market Cap", "🦉"
        ),
        Page(
            "frontend/pages/performance/bot_performance/app.py",
...
def private_pages():
    return [
        ...
        Page(
            "frontend/pages/orchestration/instances/app.py", "Instances", "🦅"
        ),
        Page(
        ...
        Page(
            "frontend/pages/orchestration/portfolio/app.py", "Portfolio", "💰"
        ),
    ]
