...
Welcome to the PZ MM Configuration Tool! This tool allows you to create, modify, visualize, backtest, and save configurations for the PZ MM trading strategy. Here’s how you can make the most out of it.
...
Start by loading the default configuration for the PZ MM strategy. This provides a baseline setup that you can customize to fit your needs.
