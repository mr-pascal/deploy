...
# Import submodules
from frontend.pages.config.pz_mm.user_inputs import user_inputs
...
initialize_st_page(title="PZ MM", icon="👨‍🏫")
backend_api_client = get_backend_api_client()

# Page content
st.text(
    "This tool will let you create a config for PZ MM, backtest and upload it to the Backend API."
)
get_default_config_loader("pz_mm")
